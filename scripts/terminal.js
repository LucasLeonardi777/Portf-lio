...
async function appendLink(url, linkText) {
    ...
    function bio() {
        const bioLines = [
            "Meu nome é Lucas, sou aspirante a programador e iniciei minha jornada aos 18 anos, atualmente trabalhando na Porto Seguro.",
            "Estou em busca de oportunidades na área de desenvolvimento web, visando construir minha carreira e aprimorar minhas habilidades.",
            "Fiz um curso na divisão IOS da TOTVS, onde aprendi HTML, CSS, JavaScript, Bootstrap, Git e GitHub.",
            "Minha formação inclui controle de versão, gerenciamento de servidores, integração de APIs, Flexbox e boas práticas de programação.",
            "Também trabalhei em projetos de equipe, utilizando o GitHub para colaboração e controle de versão.",
            " ",
            "Sou apaixonado por melhorar minhas habilidades continuamente e contribuir para projetos inovadores na área de desenvolvimento web.",
        ];
    ...
    function socials() {
        const linkedIn = "https://www.linkedin.com/in/lucas-leonardi-melero-1757732a9/";
        const github = "https://github.com/LucasLeonardi777";
